<%-- 
    Document   : faculty
    Created on : Aug 26, 2023, 8:45:46 PM
    Author     : HP
--%>
...
<html>
    ...
    <body>
           ...
           if(id==null)
            ...
            FacultyDTO u1= (FacultyDTO)session.getAttribute("dto");
          %>  
...
<div class="student">
  ...
  <div id="complainbx"> <div id="complain"><h2>Add Complain</h2></div>
      <form action="ComplainBoxController" method="post"><input name="id"  value="faculty" type="hidden"> <textarea name="box" id="" cols="30" rows="10" placeholder="Enter Your Complain Here"></textarea>  <button type="submit">Submit</button></form>
